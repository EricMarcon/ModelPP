...
- Processus ponctuels : bases mathématiques [@Leininger2017], processus courants [notamment processus de Cox: @Illian2008, chapitre 6], statistiques non paramétriques [@Illian2008, section 4.3], enjeux en écologie forestière [@Law2009];
...
Les packages nécessaires (script suivant) sont INLA[^1] et inla-bru[^2], et le package EcoFoG pour l'accès aux données de Paracou (ouverture d'un compte sur SQLServer nécessaire).

[^1]: <http://www.r-inla.org/>
[^2]: <https://sites.google.com/inlabru.org/inlabru/>
